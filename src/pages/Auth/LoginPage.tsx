...
export function LoginPage() {
  const { user, loading, needsSetup, signInEmail, signUpEmail, signInGoogle } = useAuth();
  ...
  if (!loading && user && !needsSetup) return <Navigate to="/" replace />;
  if (!loading && user && needsSetup) return <Navigate to="/setup" replace />;
