...
import { DiceTool } from './items/DiceTool';
import { CoinTool } from './items/CoinTool';
import { CalculatorTool } from './items/CalculatorTool';
import { TimerTool } from './items/TimerTool';
import { RulebookTool } from './items/RulebookTool';
import styles from './ItemDetailPage.module.css';
import rulebookStyles from './items/RulebookTool.module.css';
