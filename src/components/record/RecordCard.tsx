            ...
            return (
              <div className={styles.shareSection}>
                ...
                <div className={styles.shareRow}>
                  ...
                  >
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none"><defs><linearGradient id="ig2" x1="0%" y1="100%" x2="100%" y2="0%"><stop offset="0%" stopColor="#FFDC80"/><stop offset="25%" stopColor="#F77737"/><stop offset="50%" stopColor="#E1306C"/><stop offset="75%" stopColor="#C13584"/><stop offset="100%" stopColor="#833AB4"/></linearGradient></defs><rect x="2" y="2" width="20" height="20" rx="5" stroke="url(#ig2)" strokeWidth="2"/><circle cx="12" cy="12" r="5" stroke="url(#ig2)" strokeWidth="2"/><circle cx="17.5" cy="6.5" r="1.5" fill="url(#ig2)"/></svg>
                  </button>
                </div>
              </div>
            );
